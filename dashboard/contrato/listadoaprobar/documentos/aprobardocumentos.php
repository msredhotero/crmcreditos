...
$nombre_cliente = strtolower($dataContratoGlobal->getDato('nombre')." ".$dataContratoGlobal->getDato('paterno')." ".$dataContratoGlobal->getDato('materno'));
$baseHTML->setContentHeader ('Aprobar documentos de '.ucwords($nombre_cliente), 'Home/Contrato/Cliente/Documentos');
...
$resDocId = $documentos->traerDocumentacionPorTipoCreditoDocumentacionCompleta($idContratoGlobal,1);
...
$resDocumentaciones2 = $documentos->traerDocumentacionPorTipoCreditoDocumentacionCompleta($idContratoGlobal,1);
