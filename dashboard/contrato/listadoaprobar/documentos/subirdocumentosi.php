...
$baseHTML->setContentHeader ('Documentos administración  '.ucwords($nombre_cliente), 'Home/Contrato/Cliente/Documentos');
...
$resDocId = $documentos->traerDocumentacionPorTipoCreditoDocumentacionCompleta($idContratoGlobal,2);
...
$resDocumentaciones = $documentos->traerDocumentacionPorTipoCreditoDocumentacionCompleta($idContratoGlobal,2);
