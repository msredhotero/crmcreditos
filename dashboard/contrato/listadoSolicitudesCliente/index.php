...
$baseHTML->setContentHeader ('Listado ', 'Home/Contrato/Listado');
$idContratoGlobal = '';
                ...
                <div class="row">
                  <div class="col-lg-12 col-md-12">
                    <div class="button-demo">
                      <a href="../cliente/index.php?ns=1">
                        <button type="button" class="btn bg-light-green waves-effect btnNuevo" data-toggle="modal" data-target="#lgmNuevo">
                          <i class="material-icons">add</i>
                          <span><b>Llenar una nueva solicitud</b></span>
                        </button>
                      </a>
...
$(document).ready(function () {
 ...
 var table = $('#example').DataTable({
      "bProcessing": true,
      "bServerSide": true,
      "sAjaxSource": "../../../json/jstablasajax.php?tabla=contratosGlobalesCliente",
      "language": {
