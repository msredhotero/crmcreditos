    ...
    <section class="content">
      <div class="container-fluid">
		...
		<div class="jumbotron text-justify col-sm-10 ">
		  ...
		  <p class="lead">La autorización para consultar su historial crediticio fue registrada correctamente, en breve nos cumunicaremos con usted vía telefónica para continuar con el proceso. </p>
		  <hr class="my-4">
