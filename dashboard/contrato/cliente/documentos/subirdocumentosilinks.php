...
var myDropzone2 = new Dropzone("#frmFileUpload");
Dropzone.options.myDropzone2 ={
      ...
      init: function() {
        this.on("sending", function(file, xhr, formData){
          ...
          formData.append("idContratoGlobal", '16');
          formData.append("iddocumentacion", '4');
          formData.append("usuarioId", '777');
             alert("Enviando.....");
        });
	...
	$('.btnDocumentacion').click(function() {
		console.log("Entra a la funcion:");
			...
			url = "subirdocumentosilinks.php?id=<?php echo $idContratoGlobal;?>&documento=" + idTable;
			$(location).attr('href',url);
		});
	...
	function traerImagen(contenedorpdf, contenedor) {
		...
		Dropzone.options.frmFileUploa2d = {
			maxFilesize: 30,
			acceptedFiles: ".jpg,.jpeg,.pdf",
			accept: function(file, done) {
				done();
