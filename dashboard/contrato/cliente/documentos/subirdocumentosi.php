...
<div class="row"> 
        ...
        <form action="subir.php" id="frmFileUpload2" class="dropzone" method="post" enctype="multipart/form-data">
          ...
          <?php echo $row['estadodocumentacion']; if($row['estadodocumentacion'] == 'Falta'){ echo  $row['doctoReq'];}else{echo "<br>";} ?> </h6></button></div>
            <div class="fallback">
