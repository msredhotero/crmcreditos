   ...
   <?php echo $baseHTML->getContentHeader (); ?>
    ...
    <section class="content">
      ...
      <div  class="row col-md-12">
        <a href="documentos/aprobardocumentos.php?id=<?php echo $idContratoGlobal;?>" target="_blank"> 
          <div class="col-md-12">
          <!-- Info Boxes Style 2 -->
          <div class="info-box bg-info">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Aprobar documentos de cliente</span>
        ...
        <a href="documentos/subirdocumentosi.php?id=<?php echo $idContratoGlobal;?>" target="_blank"> 
          <div class="col-md-12">
          <!-- Info Boxes Style 2 -->
          <div class="info-box bg-info">
            <span class="info-box-icon"><i class="fa fa-file"></i></span>
            ...
            <div class="info-box-content">
              <span class="info-box-text">Subir documentos administración</span>
              <span class="info-box-number"></span>
        ...
        <a href="../../../upload/<?php echo $idContratoGlobal;?>/pdfCpmpleto.pdf" target="_blank">  
          <div class="col-md-12">
          <!-- Info Boxes Style 2 -->
          <div class="info-box bg-info">
            <span class="info-box-icon"><i class="fa fa-file"></i></span>
            ...
            <div class="info-box-content">
              <span class="info-box-text">Ver PDF completo</span>
              <span class="info-box-number"></span>
...
$("#cgs_refstatuscontratoglobal").change(function(){ 
    ...
    if(val == 3 || val == 5 || val == 6 || val == 7  || val ==12  || val ==1){
    ...
    $('.f1s').bootstrapValidator('enableFieldValidators', 'refformapago', validaCamposCredito);
      ...
      $('.f1s').bootstrapValidator('enableFieldValidators', 'refpromotor', validaCamposCredito);
      $('.f1s').bootstrapValidator('enableFieldValidators', 'refbanco', validaCamposCredito);
      $('.f1s').bootstrapValidator('enableFieldValidators', 'clabeinterbancaria', validaCamposCredito);
      ...
      $('.f1s').bootstrapValidator('validateField', 'refpromotor');
      $('.f1s').bootstrapValidator('validateField', 'refbanco');
      $('.f1s').bootstrapValidator('validateField', 'clabeinterbancaria');
...
$("#montootorgamiento").change(function(){
  filter_status_monto();
 });


function filter_status_monto(){
  var monto_credito = $('#montootorgamiento').val();
  var monto_udis = $('#limiteUDI').val();
  var empresa =  $('#refempresaafiliada').val(); // esta linea se modificara cuando se tenga el catalogo de empresas
  //var rhEmpleador = $('#rhempleador');

  var rhEmpleador = Boolean(empresa != 1);
  var valorStatus = $('#cgs_refstatuscontratoglobal').val(); 

  var val = '01';  
  var  actualizaCombo = (monto_credito > monto_udis)?true:false;
  var  superaLimiteUDIs = Boolean(monto_credito > monto_udis);
  var status = [];
  if(valorStatus=='2' || valorStatus=='3' || valorStatus=='4' || valorStatus=='5'){
    if(superaLimiteUDIs){
      swal({
                  title: "3000 UDIs",
                  text: "El monto de otorgamiento es mayor a 3000 UDIs, será necesario agregar la galería de Entrevista",
                  type: "success",
                  timer: 5000,
                  showConfirmButton: false
              });
      ...
      if( valorStatus=='2' || valorStatus=='3' || valorStatus=='4' || valorStatus=='5'){
        //2 => pendiente comite, 12 => aprobado, pendiente entrevista         
            status =["2","12"];      
        }  

    }else{
      if(rhEmpleador){
        // la empresa da el Vo.Bo. del crédito: puede tomar las opciones de 2 => pendiente comite, 3 =>aprobado, pediente empleador, 4 => rechazado
        if( valorStatus=='2' || valorStatus=='3' || valorStatus=='4'){        
            status =["2","3", "4"];  
        }
      }else{
        // se va directo a firmas: 2 => pendiente comite, 4 => rechazado,5 =>aprobado, pediente firmas
        if( valorStatus=='2' || valorStatus=='4' || valorStatus=='5'){        
            status =["2","4","5"];         
        }
      }
          ...
          var data = {      
            ...
            "optionSelected":valorStatus
            };
            console.log(status);
            // se actualiza el combo nuevamente
            filter_options(data, ['cgs_refstatuscontratoglobal']); 
            if(superaLimiteUDIs){
               // el campo de entrevista el la tabla se pone en 1 
               $('#entrevistacliente').val('1');
            }else{
               // el campo de entrevista el la tabla se pone en 0
               $('#entrevistacliente').val('0');
            }
  }
}
