...
$page = new Formulario();
$contenidoformularioNuevo = $form->formaOtorgamientoAutomatico();
...
$action = (empty($idContratoGlobal))?'otorgamientoAutomatico':'otorgamientoAutomatico';
      ...
      $.ajax({
        ...
        success: function(result){
          ...
          if (result.error == "") {
            ...
            $('#accion').val('otorgamientoAutomatico');
