...
$baseHTML->setContentHeader ('Catálogo UDI', 'Home/Catalogo/UDI');
$idContratoGlobal = '';
...
$insertar = "insertarUDI";

$modificar = "modificarUDI";
         ...
         <div class="modal-dialog modal-lg" role="document">
             <div class="modal-content">
                 <div class="modal-header">
                     <h4 class="modal-title" id="largeModalLabel">Registrar  <?php echo strtoupper($singular); ?></h4>
                 </div>
    ...
    <form class="formulario" role="form" id="sign_in">
       <div class="modal fade" id="lgmModificar" tabindex="-1" role="dialog">
           <div class="modal-dialog modal-lg" role="document">
               <div class="modal-content">
                   <div class="modal-header">
                       <h4 class="modal-title" id="largeModalLabel">MODIFICAR </h4>
                   </div>
...
<script>
  $(document).ready(function(){
    var table = $('#example').DataTable({
      "bProcessing": true,
      "bServerSide": true,
      "sAjaxSource": "../../../json/jstablasajax.php?tabla=UDI",
      "language": {
    ...
    function frmAjaxModificar(id) {
      $.ajax({
        ...
        data: {accion: 'frmAjaxModificar',tabla: 'tbudi', id: id},
