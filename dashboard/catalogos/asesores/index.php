...
$baseHTML->setContentHeader ('Catálogo Asesores', 'Home/Catalogo/Asesores');
$idContratoGlobal = '';
...
$insertar = "insertarAsesor";

$modificar = "modificarAsesor";
  ...
  $(document).ready(function(){
    ...
    function frmAjaxModificar(id) {
      $.ajax({
        ...
        data: {accion: 'frmAjaxModificar',tabla: 'tbasesores', id: id},
