...
$baseHTML->setContentHeader ('Catálogo Riesgos-Elemento', 'Home/Catalogo/Elemento');
$idContratoGlobal = '';
...
$insertar = "insertarRiesgoElemento";

$modificar = "modificarRiesgoElemento";

//////////////////////// Fin opciones ////////////////////////////////////////////////


/////////////////////// Opciones para la creacion del formulario  /////////////////////
$tabla      = "tbriesgoelementos";
...
<script>
  $(document).ready(function(){
    var table = $('#example').DataTable({
      "bProcessing": true,
      "bServerSide": true,
      "sAjaxSource": "../../../json/jstablasajax.php?tabla=riesgoElemento",
      "language": {
    ...
    function frmAjaxModificar(id) {
      $.ajax({
        ...
        data: {accion: 'frmAjaxModificar',tabla: 'tbriesgoelementos', id: id},
