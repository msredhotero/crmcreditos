...
$baseHTML->setContentHeader ('Catálogo Riesgos-Variable', 'Home/Catalogo/Variable');
$idContratoGlobal = '';
...
$insertar = "insertarRiesgoVariable";

$modificar = "modificarRiesgoVariable";

//////////////////////// Fin opciones ////////////////////////////////////////////////


/////////////////////// Opciones para la creacion del formulario  /////////////////////
$tabla      = "tbriesgovariables";

$lblCambio    = array();
$lblreemplazo = array();

//se pasa el catalogo de Indicadores



 $resultado = $serviciosCatalogos->traerRiesgoVariablePorId(1);
                  ...
                  <table id="example" class="display table " style="width:100%">
                   <thead>
                      <tr>
                        ...
                        <th>Formula</th>
                        <th>Opciones de formula</th>
                        <th>Activo en cálculo</th>                                          
                        <th>Acciones</th>
                      </tr>
                    </thead>
                    <tfoot>
...
<script>
  $(document).ready(function(){
    var table = $('#example').DataTable({
      "bProcessing": true,
      "bServerSide": true,
      "sAjaxSource": "../../../json/jstablasajax.php?tabla=riesgoVariable",
      "language": {
    ...
    function frmAjaxModificar(id) {
      $.ajax({
        ...
        data: {accion: 'frmAjaxModificar',tabla: 'tbriesgovariables', id: id},
