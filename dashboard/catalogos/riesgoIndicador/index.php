...
$baseHTML->setContentHeader ('Catálogo Riesgos-Indicador', 'Home/Catalogo/Indicador');
$idContratoGlobal = '';
...
$insertar = "insertarRiesgoIndicador";

$modificar = "modificarRiesgoIndicador";

//////////////////////// Fin opciones ////////////////////////////////////////////////


/////////////////////// Opciones para la creacion del formulario  /////////////////////
$tabla      = "tbriesgoindicadores";
...
#print_r($resRoles);
         ...
         $resultado = $serviciosCatalogos->traerRiesgoIndicadorPorId(1);
...
<script>
  $(document).ready(function(){
    var table = $('#example').DataTable({
      "bProcessing": true,
      "bServerSide": true,
      "sAjaxSource": "../../../json/jstablasajax.php?tabla=riesgoIndicador",
      "language": {
    ...
    function frmAjaxModificar(id) {
      $.ajax({
        ...
        data: {accion: 'frmAjaxModificar',tabla: 'tbriesgoindicadores', id: id},
